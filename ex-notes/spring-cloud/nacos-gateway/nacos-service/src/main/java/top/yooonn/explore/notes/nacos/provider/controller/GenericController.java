package top.yooonn.explore.notes.nacos.provider.controller;

import top.yooonn.explore.notes.nacos.provider.chain.followchain.ChainDelegator;
import top.yooonn.explore.notes.nacos.provider.chain.followchain.RuleData;
import top.yooonn.explore.notes.nacos.provider.model.Wrapper;
import top.yooonn.explore.notes.nacos.provider.model.request.FollowRequest;
import top.yooonn.explore.notes.nacos.provider.model.request.HeadlessRequest;
